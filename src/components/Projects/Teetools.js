      ...
      <Container>
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            <Col md={8}>
                ...
                <hr></hr>
                <p><img src="https://img.shields.io/npm/v/teetools-plugin.svg?label=teetools-plugin" className='img-fluid shadow-4' alt="version of plugin"></img>
                <img src="https://img.shields.io/npm/dt/teetools-plugin.svg" className='img-fluid shadow-4' alt="weekly download count"></img></p>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            <Col md={8}>
                ...
                <ListGroup>
                    <ListGroup.Item>First, install sf cli. Directions can be found <a target="_blank" rel="noreferrer" href="https://developer.salesforce.com/docs/atlas.en-us.sfdx_setup.meta/sfdx_setup/sfdx_setup_install_cli.htm#sfdx_setup_install_cli_npm" >here</a>.<br></br>
                    Installation via npm is recommended, ensure you have an up to date version of <a target="_blank" rel="noreferrer"  href="https://nodejs.org/en">node</a> installed. 
                    </ListGroup.Item>
                    ...
                    Please familiarize yourself with authenticating an org via the sf cli. Instructions can be found <a target="_blank" rel="noreferrer" href="https://developer.salesforce.com/docs/atlas.en-us.sfdx_dev.meta/sfdx_dev/sfdx_dev_auth_web_flow.htm">here</a>.
                    </ListGroup.Item>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            <Col md={8}>
                ...
                <ListGroup>
                    ...
                    <ListGroup.Item><h4>data analyze fillrate</h4><hr></hr>
